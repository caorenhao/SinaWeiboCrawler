 ...
 *         Created 2015-1-21.
 */
public class WBCrawlServerThread extends WorkingThread<WBTask> {
	 ...
	 * @param id
	 */
	public WBCrawlServerThread(MultiThreadModel<WBTask> model, int id) {
		super(model, id);
		WBCrawlServerMultiThreadMain wbMgr = (WBCrawlServerMultiThreadMain)model;
